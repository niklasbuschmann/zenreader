const Github = props =>
  <a href={'https://github.com/' + props.repo} className="github-corner">
    <svg width="80" height="80" viewBox="0 0 250 250" style={`fill: ${props.background}; color: ${props.color}; position: absolute; border: 0; top: 0; right: 0`}>
