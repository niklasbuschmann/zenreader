...
const App = props =>
  <div className={props.settings.dark ? 'dark' : 'light'} onDragOver={() => props.configure === 'Feeds' || props.actions.configure('Feeds')}>
    ...
    <main>
      ...
      {props.feeds.length ? <Articles articles={props.articles} read={props.read} selected={props.selected} search={props.search} loading={props.loading} showread={props.settings.showread} layout={props.settings.layout} mark={props.actions.mark} /> : <div><h1>Welcome</h1></div>}
    </main>
  </div>
